# Financial Analysis & TCO Research
...
## In-House Development Financials (3-Year TCO):
...
**1. Annual Subscription Costs:**
*   **Email Marketing Platform (e.g., Mailchimp, Brevo, Constant Contact):**
...
The primary goal is to increase recurring revenue by improving client re-engagement.
*   **Current Inefficiency:** With a 20% answer rate on phone calls, a significant portion of retargeting efforts are wasted.
*   **Automated Marketing Impact:** By implementing email and text marketing, All Clean Property Services can reach a broader audience more consistently and efficiently. Assuming a conservative 10% increase in effective re-engagement (e.g., from 20% to 30% of targeted clients re-booking), this translates to:
    *   If 100 clients are targeted, an additional 10 clients re-engage (30% vs 20%).
    *   Additional Revenue per Cycle: 10 clients * $150/job = $1,500
    *   If this re-engagement cycle occurs quarterly, **Annual Additional Revenue: $1,500 * 4 = $6,000**

This $6,000 annual additional revenue represents a direct increase in recurring income due to more effective retargeting.
